...
class SquareRenderer {
    ...
    private val drawOrder = shortArrayOf(0, 1, 2, 0, 2, 3) // order to draw vertex
    ...
    fun draw(cameraView: FloatArray, cameraPerspective: FloatArray) { // pass in the calculated transformation matrix
